...
public class App {
    ...
    public static int calcularTiempoViaje(double distancia, double velocidadKilometros, double velocidadHora) {
        try {
            if (
                distancia == 0 || velocidadKilometros == 0 || velocidadHora == 0)
                 {
                return -1;
            }
    ...
    public static int calcularNotaNecesaria(double porcentaje1, double porcentaje2, double porcentaje3, double porcentaje4, double porcentaje5, double nota1, double nota2, double nota3, double nota4) {
        try {
            double sumaPorcentajesConocidos = porcentaje1 + porcentaje2 + porcentaje3 + porcentaje4;
            
            double notaPromedioConocida = (nota1 * porcentaje1 + nota2 * porcentaje2 + nota3 * porcentaje3 + nota4 * porcentaje4) / sumaPorcentajesConocidos;

            double notaNecesaria = (3 * 100 - notaPromedioConocida * sumaPorcentajesConocidos) / porcentaje5;
    ...
    public static void main(String[] args) {
        ...
        System.out.println( App.calcularPesoNeto(10000));
